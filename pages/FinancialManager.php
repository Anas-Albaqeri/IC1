...
<head>
  ...
  <title>IC1 - Financial Manager Home Page</title>
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a class="logo d-flex align-items-center">
        ...
        <h1>IC1<span>.</span> Financial Manager</h1>
      </a>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="../BE/Accounts/policies.php">Current Policies</a></li>
          <li><a href="../BE/Accounts/claims.php">Pending Claims</a></li>
          <li><a href="../BE/Accounts/settlements.php">Claims Settlements</a></li>
          <li><a href="../BE/Accounts/income.php">Preimums Income</a></li>
    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="../assets/img/financial.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
