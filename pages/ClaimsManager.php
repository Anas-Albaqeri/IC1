...
<head>
  ...
  <title>IC1 -  Claims Manager Home Page</title>
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a class="logo d-flex align-items-center">
        ...
        <h1>IC1<span>.</span> Claims Manager</h1>
      </a>
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="../BE/claims/allclaims.php">View All Claims</a></li>
          <li><a href="../BE/Claims/AddClaim.php">Add Claim</a></li>
    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="../assets/img/claimsmanager.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
