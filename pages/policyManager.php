...
<head>
  ...
  <title>IC1 - Policy Manager Home Page</title>
  ...
  <header id="header" class="header d-flex align-items-center">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      <a class="logo d-flex align-items-center">
        ...
        <h1>IC1<span>.</span> Policy Manager</h1>
      </a>
      <nav id="navbar" class="navbar">
        <ul>
            <li class="dropdown"><a href="#"><span>Policies</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                   <li><a href="../BE/policies/allpolicies.php">Current Policies</a></li>
                   <li><a href="../BE/policies/pendingpolicies.php">Pending Policies</a></li>
                   <li><a href="../BE/policies/flaggedM.php">Flagged Policies</a></li>
    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="../assets/img/policymanager.jpg" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
        </div>
      </div>
    </div>
